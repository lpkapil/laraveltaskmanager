        ...
        <div class="row mb-5">
          <div class="col-md-4">
            <div class="post-entry">
              <a href="{{ url('/blogsingle') }}" class="d-block mb-4">
              ...
              <div class="post-text">
                ...
                <h3><a href="{{ url('/blogsingle') }}">Chrome now alerts you when someone steals your password</a></h3>
                <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Rem, optio.</p>
                <p><a href="{{ url('/blogsingle') }}" class="readmore">Read more</a></p>
              </div>
            </div>
          </div>
          <div class="col-md-4">
